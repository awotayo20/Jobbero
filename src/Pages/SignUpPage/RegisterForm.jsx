    ...
    <form onSubmit={handleSubmit(handleRegistration)}>
      <div className="lg:grid lg:grid-cols-7 items-center">
        <div className=" grid col-span-4 gap-5 w-full max-w-[650px] mx-auto">
          ...
          <p className="text-[#001F3F] font-medium text-[26px] font-Poppins w-[450px] mx-auto pt-14 pb-5">
          ...
          <div className="my-4">
            ...
            <label className="font-medium text-[#001F3F]  text-[26px] font-Poppins">
      ...
      <div className="flex justify-center">
        <div className=" scale-150 mt-12 mb-20">
          <ReCAPTCHA
      ...
      <button
        type="submit"
        className="px-[180px] py-[24px] text-white bg-[#001F3F] flex items-center justify-center rounded-[15px] mx-auto text-2xl font-semibold font-Poppins"
      >
        Sign Up
      </button>
    </form>
